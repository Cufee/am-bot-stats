...
func manyApplicationCommandsFactory() interface{} {
	return &[]ApplicationCommand{}
}

func (c *applicationCommandFunctions) List() (*[]ApplicationCommand, error) {
	var endpoint string
	if c.guildID == 0 {
	...
	r.factory = manyApplicationCommandsFactory
	return getManyApplicationCommands(r.Execute)
}
